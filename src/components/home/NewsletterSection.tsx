            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
              <div>
                ...
                <p className="mt-4 text-lg text-white/90">
                  Stay updated with the latest financial insights, market
                  trends, and educational content tailored to your interests.
                </p>
              </div>
              ...
              <div className="mt-12 lg:mt-0">
                <div className="bg-white p-8 rounded-xl shadow-lg">
                  <form className="space-y-5">
                    <div className="mt-8">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {topics.map((topic) => (
                          <div
                            key={topic.name}
                            className="flex items-center space-x-2 bg-white/10 hover:bg-blue/20 transition-colors px-3 py-2 rounded-full text-black"
                          >
                    ...
                    <div className="pt-2">
                      <Button
                        className="w-full finance-button-primary flex items-center justify-center"
                        type="submit"
                      >
                    ...
                    <p className="text-xs text-gray-500 text-center mt-4">
                      ...
                      of Service. We'll never share your information.
                    </p>
                  </form>
                </div>
              </div>
