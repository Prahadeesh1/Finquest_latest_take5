...
const segments = [
  ...
  },
  {
    title: "Intermediate",
    description:
      "Expand your knowledge with practical applications and deeper market insights and investment strategies.",
    features: [
      "Advanced investment strategies",
      "Portfolio diversification techniques and tips",
  ...
  },
  {
    title: "Advanced",
    description:
      "Refine your expertise with specialized business topics and be able to gain strategic insights",
    features: [
      "Complex market analysis techniques with examples",
