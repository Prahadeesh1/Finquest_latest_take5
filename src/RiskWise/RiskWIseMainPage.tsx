...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-blue-100 to-blue-200">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 py-20">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-blue-200 via-blue-150 to-blue-100">
